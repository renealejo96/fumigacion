...
class FumigationOrderDetail(db.Model):
    ...
    round_number = db.Column(db.Integer, default=1, nullable=False)
    round_name = db.Column(db.String(100), default='Vuelta 1', nullable=False)
    ...
    variety_specific = db.Column(db.String(100), nullable=True)
    phenological_stage = db.Column(db.String(50), nullable=False)
    real_age = db.Column(db.String(50), default='0', nullable=True)
    standard_beds = db.Column(db.Float, default=1.0, nullable=False)
    bed_range = db.Column(db.String(100), nullable=False)
    ...
    active_ingredient = db.Column(db.String(200), nullable=True)
    toxicological_category = db.Column(db.String(50), nullable=True)
    toxicological_color = db.Column(db.String(50), nullable=True)
